 ...
 * @author Admin
 */
@WebServlet(name="UpdateBlogDetailServlet", urlPatterns={"/updateblogdetail"})
public class UpdateBlogDetailServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateBlogDetailServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateBlogDetailServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        BlogDAO bd = new BlogDAO();
        bd.updateBlogdetail(id, title, content, image);
