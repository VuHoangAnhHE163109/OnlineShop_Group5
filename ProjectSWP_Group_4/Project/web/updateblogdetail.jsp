<%-- 
    Document   : updateblogdetail
    Created on : Nov 1, 2022, 10:08:06 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Update Blog Details</title>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <span><i class="fa fa-cloud-upload"></i>&nbsp;&nbsp;</span>Update Blog Detail
                                </div>
                                <div class="card-body">
                                                ...
                                                <form method="post" action="updateblogdetail">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-xs-12 col-md-12">
                                                            ...
                                                            <div class="image-area"><img id="imageResult" src="resources/img/Blog/${BlogDetail.imgBlogDetail}" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
                                                        </div>
                                                        <input type="hidden" name="BlogDetailId" value="${BlogDetail.blogDetailID}"/>
                                                        <div class="col-lg-6 col-xs-12 col-md-12">
                                                            <div class="col-md-12">Title<input type="text" class="form-control" name="title" value="${BlogDetail.title}"></div>
